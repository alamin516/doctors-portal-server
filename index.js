...
const uri = `mongodb+srv://${process.env.DOCTOR_DB}:${process.env.DOCTOR_DB_PASSWORD}@cluster0.ts14m7y.mongodb.net/?retryWrites=true&w=majority`;
        ...
        */
        ...
        app.post('/bookings', async (req, res) => {
            ...
            if (alreadyBooked.length) {
                const message = `You already have a booking at ${booking.treatmentName} on ${booking.appointmentDate} `
